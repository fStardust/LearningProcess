...
def send(msg):
    ...
    rec_user = "2111732367@qq.com"  # 收件者邮箱
    aluo = "2111732367@qq.com"  # -- 接收者邮箱
...
# 获取今天当前部分信息数据
def now_weather():
    url = 'https://free-api.heweather.net/s6/weather/now?key=' + my_key + '&location=%E6%98%86%E6%98%8E'
    header = {
...
def now_and_future_twodays_weather():
    ...
    url = 'https://free-api.heweather.net/s6/weather/forecast?key=' + my_key + '&location=%E6%98%86%E6%98%8E'
    header = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36'
    }
